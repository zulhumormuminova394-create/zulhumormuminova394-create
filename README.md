...
Open to remote Python/Django opportunities · Based in Osh, Kyrgyzstan
...
Developed independently. Backend-focused Django application — the repository shows the implementation and how to run the project.
