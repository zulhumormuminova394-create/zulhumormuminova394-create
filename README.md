...
Backend developer focused on Python and Django. I build reliable APIs, backend services, and maintainable web applications with an emphasis on clean architecture, clear code, and practical delivery.

</div>
I am open to remote Python and Django opportunities and based in Osh, Kyrgyzstan.
...
- FastAPI (learning) · Backend reliability · Clean code
...
Django · Django REST Framework · PostgreSQL · Docker (learning) · FastAPI (learning)
<a href="https://github.com/nm-backend/nerzhaveyka" title="Nerzhaveyka repository">
  <img src="https://img.shields.io/badge/Repository-Nerzhaveyka-111827?style=for-the-badge&logo=github&logoColor=white" alt="Repository — Nerzhaveyka" />
</a>

</div>
Developed independently, this Django-based project focuses on backend structure, API design, and practical deployment workflows.
...
Developed independently. Backend-focused Django application — repository shows the implementation and how to run the project.

Technologies: Python · Django · Django REST Framework · PostgreSQL / SQLite · HTML/CSS

<br/>

<a href="https://github.com/nm-backend/nerzhaveyka" title="Nerzhaveyka repository"><img src="https://img.shields.io/badge/Repository-Nerzhaveyka-111827?style=for-the-badge&logo=github&logoColor=white" alt="Repository — Nerzhaveyka" /></a>

</div>

<!--
Screenshot placeholder (hidden until a file exists).

To display a screenshot:
  1) Add an image at assets/nerzhaveyka_screenshot.png in this repository.
  2) Remove this comment block and add:
## GitHub snapshot

<div align="center">
  <img src="assets/nerzhaveyka_screenshot.png" alt="Nerzhaveyka screenshot" />
</div>

Keep screenshots focused on app UI or API responses and avoid sensitive data.
-->
...
@@ -86,13 +60,10 @@ Keep screenshots focused on app UI or API responses and avoid sensitive data.
---
...
<a href="https://www.linkedin.com/in/nurullo-musajanov-040b31337/" title="LinkedIn" style="margin-left:8px"><img src="https://img.shields.io/badge/LinkedIn-Connect-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
<a href="https://t.me/nm_2110" title="Telegram" style="margin-left:8px"><img src="https://img.shields.io/badge/Telegram-Message-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram" /></a>

</div>
- GitHub: [nm-backend](https://github.com/nm-backend)
- LinkedIn: [Nurullo Musajanov](https://www.linkedin.com/in/nurullo-musajanov-040b31337/)
